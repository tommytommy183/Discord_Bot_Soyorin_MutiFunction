    ...
    public class Game2048Service
    {
        ...
        private string GetTileEmoji(int value)
        {
            return value switch
            {
                ...
                4 => "4️⃣",
                8 => "8️⃣",
                16 => "<a:95333c6fabb3e5d23e6325817ce09986:1293572566715203594>",
                32 => "<:anon_ha_1:1293560817194897469>",
                64 => "<:taki_ha_1:1293560646012637195>",
                128 => "🟢",
                256 => "🔵",
                512 => "🟣",
                1024 => "<:tomori_happy:1293560266969055434>",
                2048 => "🏆",
                _ => "⭐"
            };
        }

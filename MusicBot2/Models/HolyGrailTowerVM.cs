...
namespace MusicBot2.Models
{
    ...
    public class HolyGrailTowerPlayer
    {
        ...
        public int SummonTickets { get; set; } = 10; // �l���

        [JsonPropertyName("saintQuartz")]
        public int SaintQuartz { get; set; } = 0; // �t���ۡ]premium�f���^

        [JsonPropertyName("ownedServants")]
        public List<TowerServant> OwnedServants { get; set; } = new(); // �֦����q�̹�Ų

        [JsonPropertyName("highestFloor")]
        public int HighestFloor { get; set; } = 0; // �̰���F�h��

        [JsonPropertyName("totalRuns")]
        public int TotalRuns { get; set; } = 0; // �`�D�Ԧ���
        ...
        public Dictionary<string, int> PermanentUpgrades { get; set; } = new(); // �ä[�ɯ�

        [JsonPropertyName("createdAt")]
        public DateTime CreatedAt { get; set; } = DateTime.UtcNow;
    }

    /// <summary>�q�̥d���]��Ų�^</summary>
    public class TowerServant
    {
        ...
        public List<string> Cards { get; set; } = new(); // 5�i���O�d, Ĵ�p ["buster", "buster", "arts", "quick", "quick"]
    ...
    public class HgwTowerRun
    {
        ...
        public List<HgwTowerServantInstance> Team { get; set; } = new(); // ���e�X�Զ���]�ܦh3�H�^

        public int Gold { get; set; } = 50; // �����_�I��o������
        public List<HgwTowerRelic> Relics { get; set; } = new(); // ��o����

        public HgwTowerEncounter CurrentEncounter { get; set; } // ���e�D�J�ƥ�
        public List<string> EventLog { get; set; } = new(); // �D�J��x

        public DateTime StartTime { get; set; } = DateTime.UtcNow;
        public bool IsFinished { get; set; } = false;
    }

    /// <summary>�_�I�����q�̹���</summary>
    public class HgwTowerServantInstance
    {
        ...
        public List<string> Cards { get; set; } = new(); // 5�i���O�d
        public string FaceUrl { get; set; }
        public string FullImageUrl { get; set; }
        public List<HgwSkillData> Skills { get; set; } = new();
    ...
    public class HgwTowerEncounter
    {
        ...
        // FGO ���O�d�԰��M�ݪ��A
        public int CritStars { get; set; } = 0; // �W�^�X�ֿn�������P

        public List<HgwCardPlay> HandCards { get; set; } = new(); // ���e��P��P (5�i)
        public List<HgwCardPlay> SelectedCards { get; set; } = new(); // ���a�w�襤���X�⪺�P
    ...
    /// <summary>�Ĺ�NPC�Ǫ��ƭ�</summary>
    public class HgwTowerEnemy
    {
        public string Name { get; set; }
        public string ClassName { get; set; } // FGO �^�F¾��
        public int CurrentHp { get; set; }
        public int MaxHp { get; set; }
        public int Attack { get; set; }
        public int Defense { get; set; }
    ...
    /// <summary>FGO ���O�d���X�欰</summary>
    public class HgwCardPlay
    {
        public int ServantIndex { get; set; } // ���ͯ��ޡG0, 1, 2
        public string ServantName { get; set; }
        public string CardType { get; set; } // "buster", "arts", "quick", "np"
        public int CardIndex { get; set; } // �b��P (0~4) ���� index�A�p�G�O�_��d�h�� -1
        public int CritChance { get; set; } = 0; // �������v (0 - 100)
    }
    ...
    /// <summary>�ä[�ɯŶ���</summary>
    public static class PermanentUpgrades
    {
        public const string MAX_TEAM_SIZE = "max_team_size";      // �̤j����H�� (�q�{3)
        public const string STARTING_GOLD = "starting_gold";      // �_�l����
        public const string NP_GAIN = "np_gain";                  // NP �B�~��o�ʤ���
        public const string HP_BOOST = "hp_boost";                // �_���q�B�~�[��
    }

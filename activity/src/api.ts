import type { TowerRun, ActionRequest, ApiResponse, PassiveOption } from './types';
...
export interface StartRunRequest {
  channelId: string; userId: string; userName: string; pokemonIndex: number; passiveId?: string;
}
